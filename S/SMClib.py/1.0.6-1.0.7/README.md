# Comparing `tmp/SMClib.py-1.0.6.tar.gz` & `tmp/SMClib.py-1.0.7.tar.gz`
...
## Comparing `SMClib.py-1.0.6.tar` & `SMClib.py-1.0.7.tar`
...
### Comparing `SMClib.py-1.0.6/LICENSE.txt` & `SMClib.py-1.0.7/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `SMClib.py-1.0.6/PKG-INFO` & `SMClib.py-1.0.7/PKG-INFO`
...
### Comparing `SMClib.py-1.0.6/SMClib.py.egg-info/PKG-INFO` & `SMClib.py-1.0.7/SMClib.py.egg-info/PKG-INFO`
...
### Comparing `SMClib.py-1.0.6/setup.py` & `SMClib.py-1.0.7/setup.py`
